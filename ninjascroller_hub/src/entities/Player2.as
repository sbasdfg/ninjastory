package entities
{
	...
	public class Player2 extends Box2DPhysicsObject
	{
		...
		public var onEnterGoalArea:Signal;
		...
		public var goalType:String = "null";
		...
		public function Player2(name:String, params:Object = null)
		{
			...
			onEnterGoalArea = new Signal(String);
		...
		override public function update(timeDelta:Number):void
		{
			...
			if (controlsEnabled)
			{
				...
				if (_lookingup && goalType != "null") 
				{
					onEnterGoalArea.dispatch(goalType);
					//trace(goalType);
				}
				...
				if (_ce.input.justDid("jump", inputChannel) && !_onGround && Globals.canDoubleJump && !_isDoubleJumping && !_isWallKicking && !_isWallClimbing)
				{
					velocity.y = -jumpHeight;
					onJump.dispatch();
				...
				{
					//trace (!_onGround, Globals.canDoubleJump, !_isDoubleJumping);
				}
		...
		override public function handleEndContact(contact:b2Contact):void {
			...
			var colliderType:String = (collider as Box2DPhysicsObject).name;
			
			//trace(colliderType);
			
			if (colliderType == "goal") goalType = "null";
